(function(){
    var ClusterMaker = function(){
        var ClusterMaker = function(){
        };
        ClusterMaker.prototype.data = getterSetter([], function(arrayOfArrays) {
            var n = arrayOfArrays[0].length;
            return (arrayOfArrays.map(function(array) {
                return array.length == n;
            }).reduce(function(boolA, boolB) { return (boolA & boolB) }, true));
        });
        ClusterMaker.prototype.clusters = function clusters() {
        ...
        ClusterMaker.prototype.k = getterSetter(undefined, function(value) { return ((value % 1 == 0) & (value > 0)) });

        ClusterMaker.prototype.iterations = getterSetter(Math.pow(10, 3), function(value) { return ((value % 1 == 0) & (value > 0)) });
